...
default['axonops']['cassandra']['authenticator'] = 'AllowAllAuthenticator'
default['axonops']['cassandra']['authorizer'] = 'AllowAllAuthorizer'
...
default['axonops']['cassandra']['cidr_authorizer'] = 'CassandraCIDRAuthorizer'
...
default['axonops']['cassandra']['heap_size'] = nil  # Will be auto-calculated if not set
default['axonops']['cassandra']['heap_newsize'] = nil  # For CMS only
default['axonops']['cassandra']['max_direct_memory_size'] = nil  # Defaults to half of heap
...
default['axonops']['cassandra']['max_sstables_to_compact'] = 64
default['axonops']['cassandra']['target_sstable_size'] = '1GiB'
default['axonops']['cassandra']['sstable_growth'] = 0.3333333333333333
default['axonops']['cassandra']['min_sstable_size'] = '100MiB'
...
default['axonops']['cassandra']['default_keyspace_rf'] = 2
default['axonops']['cassandra']['audit_logging_max_queue_weight'] = 268435456
default['axonops']['cassandra']['minimum_replication_factor_fail_threshold'] = 2
default['axonops']['cassandra']['maximum_replication_factor_warn_threshold'] = 3
